...
const Navbar = ({ activePage, handleNavClick, toggleNavbar, isNavbarOpen }) => {
  return (
    <>
      <div
        className={`2xl:w-74 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-4 pl-8 pb-14 md:pb-0 absolute md:relative z-10 ${
      ...
      >
        ...
        <div className="flex flex-col flex-grow">
          {navItems.map((items, index) => (
            ...
            >
              <i className={`bx ${items.icon} text-xl text-pink-400`}></i>
